...
def get_map_image(image_map, tweet_map):
    ...
    draw_map_places()
    if tweet.place != None and MAP_SHOW_CIRCLE:
        draw_ellipse()
...
def draw_ellipse():
    ...
    d.ellipse((tweet.place.coord_x - 2000, tweet.place.coord_y - 2000, tweet.place.coord_x + 2000, tweet.place.coord_y + 2000), outline=(255,255,255,100), width=2000 - int(MAP_CIRCLE_SIZE/2))
