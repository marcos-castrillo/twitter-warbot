...
raw_weapon_list = [
    ...
    [1, u'las páginas amarillas', 1, 0],
    [1, u'una percha de Zara', 0, 2],
    [1, u'el tiesto de un ficus', 0, 2],
    ...
    [1, u'un cenicero', 0, 2],
    [1, u'un balón medicinal', -1, 3],
    [2, u'unos tirantes con la bandera de ESPAÑA', 0, 3],
    [2, u'una vara de hierro', 3, 0],
    ...
    [2, u'un hacha', 0, 5],
    [2, u'una escopeta de balines', 0, 5],
    [2, u'una navaja de Albacete', 1, 5],
    [3, u'un cinturón con la bandera de ESPAÑA', 3, 3],
    [3, u'una escopeta de caza', 0, 7],
    [3, u'un Rottweiler', 5, 4],
    [3, u'el escudo del Capitán América', 9, 0],
    [3, u'un francotirador', -1, 9],
    [3, u'un bazooka', -3, 10],
    [3, u'un escudo antidisturbios', 10, -3],
    [3, u'un chaleco antibalas', 10, -2],
    [3, u'el puño de Thanos', 0, 9],
    [3, u'el perro Excálibur', 4, 4],
    [3, u'la cabra de la Legión', 4, 4]
]
...
raw_powerup_list = [
    ...
    [1, u'una bota de vino', 1, 1],
    [1, u'unas Papadeltas', 1, 1],
    [2, u'un paquete de cereales rellenos de leche del Mercadona', 2, 1],
    [2, u'un porrito', 2, 2],
    [2, u'una caja de Fresón de Palos', 1, 2],
    [2, u'un jamón de Jabugo', 2, 1],
