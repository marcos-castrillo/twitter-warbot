...
class Simulation_Probab(object):
    ...
    # Constructor
    def __init__(self, item, move, battle, injure, steal, monster, destroy, trap, infect, atract, suicide, revive):
        if (item + move + battle + injure + steal + monster + destroy + trap + infect + atract + suicide + revive) != 100:
