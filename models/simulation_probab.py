...
class Simulation_Probab(object):
    ...
    # Constructor
    def __init__(self, item, move, battle, destroy, monster, trap, suicide, revive):
        if (item + move + battle + destroy + monster + trap + suicide + revive) != 100:
    ...
    def calculate_action_numbers(self):
        ...
        self.trap_action_number = self.monster_action_number + self.trap_probab
