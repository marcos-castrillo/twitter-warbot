...
class Simulation_Probab(object):
    ...
    # Constructor
    def __init__(self, item, move, battle, destroy, accident, suicide, revive):
        if (item + move + battle + destroy + accident + suicide + revive) != 100:
    ...
    def calculate_action_numbers(self):
        ...
        self.accident_action_number = self.destroy_action_number + self.accident_probab
