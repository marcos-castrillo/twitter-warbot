...
class Simulation_Probab(object):
    ...
    # Constructor
    def __init__(self, suicide, revive, trap, infect, destroy, atract, monster, steal, move, item, battle):
        if (suicide + revive + trap + infect + destroy + atract + monster + steal + move + item + battle) != 100:
    ...
    def calculate_action_numbers(self):
        ...
        self.atract_action_number = self.destroy_action_number + self.atract_probab
